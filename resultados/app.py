...
fig_pie = px.pie(df, names='Género', title='Distribución de Género de los Encuestados', hole=0.3,
                 color_discrete_sequence=px.colors.qualitative.Set3)
...
fig_combined = px.box(df_melted, x='Pregunta', y='Puntuación', title='Distribución de Respuestas por Pregunta',
                      color='Pregunta', color_discrete_sequence=px.colors.qualitative.Set3)
